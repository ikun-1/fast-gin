...
func newPermission(db *gorm.DB, opts ...gen.DOOption) permission {
	...
	_permission.Type = field.NewInt8(tableName, "type")
	_permission.PID = field.NewUint(tableName, "p_id")
	_permission.Path = field.NewString(tableName, "path")
	_permission.Component = field.NewString(tableName, "component")
	_permission.Icon = field.NewString(tableName, "icon")
	_permission.SortOrder = field.NewInt(tableName, "sort_order")
...
type permission struct {
	...
	Type      field.Int8   // 类型 1目录 2菜单 3按钮
	PID       field.Uint   // 父权限ID
	Path      field.String // 前端路由路径
...
func (p *permission) updateTableName(table string) *permission {
	...
	p.PID = field.NewUint(table, "p_id")
	p.Path = field.NewString(table, "path")
	p.Component = field.NewString(table, "component")
...
func (p *permission) fillFieldMap() {
	...
	p.fieldMap["component"] = p.Component
