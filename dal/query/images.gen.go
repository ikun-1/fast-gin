...
func newImage(db *gorm.DB, opts ...gen.DOOption) image {
	...
	_image.Address = field.NewString(tableName, "address")
	_image.FileName = field.NewString(tableName, "file_name")
	_image.FileHash = field.NewString(tableName, "file_hash")
...
type image struct {
	...
	Address   field.String // 图片地址
	FileName  field.String // 原始文件名
	FileHash  field.String // 文件MD5哈希
...
func (i *image) updateTableName(table string) *image {
	...
	i.FileHash = field.NewString(table, "file_hash")
...
func (i *image) fillFieldMap() {
	...
	i.fieldMap["file_hash"] = i.FileHash
