...
func newNotification(db *gorm.DB, opts ...gen.DOOption) notification {
	...
	_notification.FromUserID = field.NewUint(tableName, "from_user_id")
	_notification.ToUserID = field.NewUint(tableName, "to_user_id")
...
type notification struct {
	...
	FromUserID field.Uint   // 发送者ID
	ToUserID   field.Uint   // 接收者ID
	Type       field.String // 类型(invitation)
	Message    field.String // 消息内容
	Status     field.String // 状态(unread/read)
...
func (n *notification) updateTableName(table string) *notification {
	...
	n.FromUserID = field.NewUint(table, "from_user_id")
	n.ToUserID = field.NewUint(table, "to_user_id")
...
func (n *notification) fillFieldMap() {
	...
	n.fieldMap["from_user_id"] = n.FromUserID
	n.fieldMap["to_user_id"] = n.ToUserID
